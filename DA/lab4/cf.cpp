...
int main(){
    ...
    TTrie trie;
    char prevSymb;
    unsigned int index = 0, number, wordNumber = 0, curLineNumber = 0, lineNumber = 1;
    std::string str;
    std::string rts;
    ...
    /*if(lineEndings.size() == 45){    
        std::cout << trie.qq() <<'\n';
        std::cout << occur.size() << "\n";
    }*/
    for(unsigned int i = 0; i < occur.size(); i+=3){
        //if(lineEndings.size() == 45) std::cout << "hui2\n";
    ...
    //if(lineEndings.size() == 45) std::cout << "hui3\n";
    //std::cout << '\n';
    /*line column number 
